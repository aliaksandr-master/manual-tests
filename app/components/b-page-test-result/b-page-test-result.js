  ...
  return `
    <div class="b-page-test-result">
      ...
      <div class="b-page-test-result__reload-btn-wr text-center">
        <button type="button" class="b-page-test-result__reload-btn btn btn-lg btn-default" onclick="confirm('Текущий прогресс тестирования будет потерян') && window.location.reload()">Начать заново</button>
      </div>
    </div>
  `
},
